...
class TrainingArguments:
    ...
    logging_steps: int = field(default=50000, metadata={"help": "Log every X updates steps."})
    save_steps: int = field(default=38196, metadata={"help": "Save checkpoint every X updates steps."})
