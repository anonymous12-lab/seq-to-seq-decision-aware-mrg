...
class BaseModelOutput(ModelOutput):
    ...
    last_hidden_state1: torch.FloatTensor = None
    last_hidden_state2: torch.FloatTensor = None
    last_hidden_state3: torch.FloatTensor = None
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
@dataclass
class BaseModelOutput2(ModelOutput):
    """
    Base class for model's outputs, with potential hidden states and attentions.
...
@dataclass
class BaseModelOutput3(ModelOutput):
    """
    Base class for model's outputs, with potential hidden states and attentions.
    ...
    last_hidden_state: torch.FloatTensor = None
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions3: Optional[Tuple[torch.FloatTensor]] = None
...
class Seq2SeqModelOutput(ModelOutput):
    ...
    cross_attentions: Optional[Tuple[torch.FloatTensor]] = None
    encoder_last_hidden_state1: Optional[torch.FloatTensor] = None
    encoder_last_hidden_state2: Optional[torch.FloatTensor] = None
    encoder_last_hidden_state3: Optional[torch.FloatTensor] = None
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    decision_output: Optional[torch.Tensor] = None
...
class Seq2SeqLMOutput(ModelOutput):
    ...
    loss: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None
    indexs: Optional[int] = None
    decision_label: Optional [torch.FloatTensor] = None
    past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    decoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    decoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    cross_attentions: Optional[Tuple[torch.FloatTensor]] = None
